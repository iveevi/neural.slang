...
@pytest.mark.parametrize("random_seed", RANDOM_SEEDS)
def test_network_without_encoding_nn_linear(device, make_kernel, random_seed):
...
@pytest.mark.parametrize("random_seed", RANDOM_SEEDS)
def test_network_without_encoding_derivative_nn_linear(device, make_kernel, random_seed):
